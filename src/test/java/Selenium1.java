...
public class Selenium1 {
    ...
    public static void main(String[] args) {
        ...
        //Morali smo chromedriver.exe dajl da skinemo i smestimo u određen folder
        //nakon toga komanda setProperty bi citala taj fajl
        //Postojao je problem kod određenih operativnih sistema gde je antivirus brisao fajl
        //i testovi bi padali jer fajl vise ne postoji pa ste morali da podesavate izuzetak u antivirusu za taj fajl ili direktorijum
